    ...
    <div className="bg-slate-50 rounded-lg border-1.5 shadow-md overflow-hidden hover:scale-105 transition-transform duration-300 flex flex-col h-full min-h-[400px]">
      ...
      <div className="p-4 flex flex-col flex-grow">
        ...
        <div className="flex items-center mb-1 text-sm">
          <svg
            className="w-4 h-4 text-indigo-700 mr-1"
        ...
        <div className="flex items-center mb-1 text-sm">
          ...
          <span className="ml-1 text-gray-600">{property.lotSqft} SqFt</span>
        </div>
        <div className="flex items-center mb-1 text-sm">
          <svg
            className="w-4 h-4 text-indigo-700 mr-1"
          ...
          <span className="ml-1 text-gray-600">{property.built}</span>
        </div>
        <div className="flex items-start mb-4 text-sm">
          <svg
            className="w-10 h-4 text-indigo-700 mr-1"
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          ...
          <div>
            ...
            <span className="ml-1 text-gray-600">{property.description}</span>
          </div>
        </div>
        <div className="mt-3 flex justify-center">
          <a
            ...
            className="group relative inline-block overflow-hidden border px-8 py-3 focus:outline-none focus:ring w-full text-center rounded-b-lg text-xs font-bold text-blue-600 transition-colors group-hover:text-white hover:bg-blue-600 hover:text-white"
          >
            Read More
          </a>
        </div>
